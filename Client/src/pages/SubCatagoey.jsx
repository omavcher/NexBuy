...
import './css/SubCatagoey.css';
import api from '../api'; // Ensure api is imported correctly
...
const SubCatagoey = () => {
  ...
  useEffect(() => {
    const getProducts = async () => {
      try {
        ...
        // Set initial price range and slider bounds
  ...
  useEffect(() => {
    ...
    // Filter products based on price range and rating
    ...
    if (selectedSortOption === 'Price: highest to low') {
      ...
      updatedProducts.sort((a, b) => b.date - a.date); // Assuming products have a 'date' property
